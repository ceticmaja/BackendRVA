...
INSERT INTO "tim"("id", "naziv", "osnovan", "sediste", "liga")
VALUES (NEXTVAL('tim_seq'), 'Liverpool FC', to_date('03.06.1892.', 'dd.mm.yyyy.'), 'Liverpul', 2);
INSERT INTO "tim"("id", "naziv", "osnovan", "sediste", "liga")
VALUES (NEXTVAL('tim_seq'), 'FC Bayern Munchen', to_date('27.02.1900.', 'dd.mm.yyyy.'), 'Minhen', 4);
INSERT INTO "tim"("id", "naziv", "osnovan", "sediste", "liga")
VALUES (NEXTVAL('tim_seq'), 'Real Madrid CF', to_date('06.03.1902.', 'dd.mm.yyyy.'), 'Madrid', 1);
INSERT INTO "tim"("id", "naziv", "osnovan", "sediste", "liga")
VALUES (NEXTVAL('tim_seq'), 'Juventus FC', to_date('01.11.1897.', 'dd.mm.yyyy.'), 'Torino', 4);
INSERT INTO "tim"("id", "naziv", "osnovan", "sediste", "liga")
VALUES (NEXTVAL('tim_seq'), 'Manchester City FC', to_date('16.04.1897.', 'dd.mm.yyyy.'), 'Mancester', 2);
...
VALUES (NEXTVAL('igrac_seq'), 'Alisson', 'Becker', '1', to_date('02.10.1992.', 'dd.mm.yyyy.'), 1, 2);
INSERT INTO "igrac" ("id", "ime", "prezime","broj_reg", "datum_rodjenja", "nacionalnost", "tim")
VALUES (NEXTVAL('igrac_seq'), 'Lionel', 'Messi', '10', to_date('24.06.1987.', 'dd.mm.yyyy.'), 2, 1);
INSERT INTO "igrac" ("id", "ime", "prezime","broj_reg", "datum_rodjenja", "nacionalnost", "tim")
VALUES (NEXTVAL('igrac_seq'), 'Joshua', 'Kimmich', '6', to_date('08.02.1995.', 'dd.mm.yyyy.'), 3, 3);
INSERT INTO "igrac" ("id", "ime", "prezime","broj_reg", "datum_rodjenja", "nacionalnost", "tim")
VALUES (NEXTVAL('igrac_seq'), 'Sergio', 'Ramos', '4', to_date('30.03.1986.', 'dd.mm.yyyy.'), 4, 4);
INSERT INTO "igrac" ("id", "ime", "prezime","broj_reg", "datum_rodjenja", "nacionalnost", "tim")
VALUES (NEXTVAL('igrac_seq'), 'Thiago', 'Alcantara', '6', to_date('11.04.1991.', 'dd.mm.yyyy.'), 4, 3);
INSERT INTO "igrac" ("id", "ime", "prezime","broj_reg", "datum_rodjenja", "nacionalnost", "tim")
VALUES (NEXTVAL('igrac_seq'), 'Alphonso', 'Davies', '19', to_date('02.11.2000.', 'dd.mm.yyyy.'), 5, 4);
INSERT INTO "igrac" ("id", "ime", "prezime","broj_reg", "datum_rodjenja", "nacionalnost", "tim")
VALUES (NEXTVAL('igrac_seq'), 'Christiano', 'Ronaldo', '7', to_date('05.02.1985.', 'dd.mm.yyyy.'), 6, 5);
INSERT INTO "igrac" ("id", "ime", "prezime","broj_reg", "datum_rodjenja", "nacionalnost", "tim")
VALUES (NEXTVAL('igrac_seq'), 'Robert', 'Lewandowski', '9', to_date('21.08.1988.', 'dd.mm.yyyy.'), 7, 3);
INSERT INTO "igrac" ("id", "ime", "prezime","broj_reg", "datum_rodjenja", "nacionalnost", "tim")
VALUES (NEXTVAL('igrac_seq'), 'Kevin', 'de Bruyne', '17', to_date('28.06.1991.', 'dd.mm.yyyy.'), 8, 6);
